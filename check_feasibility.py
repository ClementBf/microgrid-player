...
if __name__ == "__main__":
    ...
    p = Player()
    p.compute_all_load()
    dc_load_profile = p.HDC
    it_load_profile = p.lIT
    dc_infeas_score = check_data_center_feasibility(dc_load_profile,p.cop_cs,p.cop_hp,p.eer,p.horizon,p.deltat,it_load_profile)
    print("DC infeas score prof.: ", dc_infeas_score)
